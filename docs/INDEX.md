...
- 토대 논문(다층모델·조사프로세스 차용): **SSRN https://papers.ssrn.com/sol3/papers.cfm?abstract_id=6725750** (PDF는 저작권상 레포 미동봉 — SSRN서 받기).
...
| 토대 선행논문 → SSRN 6725750 (Kim & Jeong) | 다층모델·조사프로세스 차용. PDF 미동봉(저작권) | 공통 |
